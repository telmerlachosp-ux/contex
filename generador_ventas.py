...
def generar_venta(
    ...
    glosa_venta = "Venta de mercadería usando las cuentas 12121, 40111 y 70121"
    glosa_costo = "Costo de venta y salida de mercadería del almacén usando las cuentas 69111 y 20111"
    glosa_cobro = "Cobro de la factura por venta usando las cuentas 1011 y 12121"
    ...
    if condicion_cobro.upper() == "CREDITO":
        ...
        cuentas.append({"asiento": 1, "codigo": "1011", "cuenta": "Caja", "debe": total, "haber": 0, "glosa": glosa_venta})
    ...
    if condicion_cobro.upper() == "CREDITO":
        cuentas.append({"asiento": 3, "codigo": "1011", "cuenta": "Caja", "debe": total, "haber": 0, "glosa": glosa_cobro})
